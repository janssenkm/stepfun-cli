...
for (const c of [
  ...
  { name: 'speech rejects invalid voice label key', args: ['speech', 'synthesize', '--text', 'x', '--model', 'step-tts-2', '--voice-label', 'pitch:high', '--dry-run'], error: /key must be lang\|emotion\|style/ },
  { name: 'speech rejects voice-label on default TTS model', args: ['speech', 'synthesize', '--text', 'x', '--voice-label', 'lang:Cantonese', '--dry-run'], error: /not supported by stepaudio-2\.5-tts/ },
  ...
  { name: 'file upload rejects removed --purpose flag', args: ['file', 'upload', '--url', 'https://example.com/x', '--purpose', 'fine-tune', '--dry-run'], error: /Unknown flag --purpose/ },
